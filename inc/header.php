...
<body>
  ...
  ?>
    <div class="col-container">
        ...
        <li class="nav-item tasks<?php if ($page == "tasks") { echo " on"; } ?>"><a class="nav-link" href=<?php echo getenv('APP_URL')."/task_list.php"?>>View Tasks</a></li>
        <li class="nav-item task<?php if ($page == "task") { echo " on"; } ?>"><a class="nav-link" href=<?php echo getenv('APP_URL')."/task.php"?>>Add Tasks</a></li>
      </ul>
        <ul class="nav">
